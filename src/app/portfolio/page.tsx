    ...
    <div className="min-h-screen bg-brand-background">
        ...
        <div className="container mx-auto px-4 py-4 md:py-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex-1">
              <h1 className="text-2xl md:text-3xl font-bold gradient-text">Yield Desk Portfolio</h1>
              <p className="text-muted-foreground mt-1 text-sm md:text-base">
                Track your tokenised fixed income investments
              </p>
            </div>
            <div className="flex flex-wrap gap-2 md:gap-3">
              <button className="px-3 md:px-4 py-2 text-sm border border-input bg-background hover:bg-accent hover:text-accent-foreground rounded-lg font-medium transition-colors">
                Export CSV
              </button>
              <button 
                onClick={addDemoPositions}
                className="px-3 md:px-4 py-2 text-sm border border-input bg-background hover:bg-accent hover:text-accent-foreground rounded-lg font-medium transition-colors"
              >
                Add Demo
              </button>
              <button 
              ...
              <button className="px-3 md:px-4 py-2 text-sm bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg font-medium transition-colors">
                Refresh
              </button>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-6">
          <div className="card-hover p-3 md:p-6 rounded-lg border bg-card text-card-foreground shadow-sm">
            <div className="flex flex-row items-center justify-between space-y-0 pb-2">
              <h3 className="text-xs md:text-sm font-medium text-muted-foreground">Wallet Balance</h3>
              <div className="text-lg md:text-2xl">💳</div>
            </div>
            <div className="text-lg md:text-2xl font-bold">{formatCurrency(walletBalance)}</div>
            <div className="text-xs text-muted-foreground">Available USDC</div>
          </div>
          <div className="card-hover p-3 md:p-6 rounded-lg border bg-card text-card-foreground shadow-sm">
            <div className="flex flex-row items-center justify-between space-y-0 pb-2">
              <h3 className="text-xs md:text-sm font-medium text-muted-foreground">Total Portfolio Value</h3>
              <div className="text-lg md:text-2xl">💰</div>
            </div>
            <div className="text-lg md:text-2xl font-bold">{formatCurrency(portfolioData.totalValue)}</div>
